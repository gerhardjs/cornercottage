<?php
  ...
  */
  ...
  $receiving_email_address = 'info@cornercottage.co.za';
  ...
  $book_a_table->subject = "New booking request.";
  ...
  */
  ...
  $book_a_table->add_message( $_POST['arrival'], 'Arrival', 4);
  $book_a_table->add_message( $_POST['departure'], 'Departure', 4);
